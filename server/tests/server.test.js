...
describe("GET /todos/:id", () => {
    ...
    it("It should not return a todo created by other user", (done) => {
        request(app)
...
describe("DELETE /todos/:id", () => {
    ...
    it("It should not remove a todo doesn't owned by user", (done) => {
        var hexId = todos[0]._id.toHexString();
        request(app)
        .delete(`/todos/${hexId}`)
...
describe("PATCH /todos/:id", () => {
    ...
    it("It should not update a todo which is not created by me", (done) => {
        var hexId = todos[0]._id.toHexString();
        var body = {
            "text": "This should be the new text",
            "completed": true
